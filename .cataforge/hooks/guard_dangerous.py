...
Test:
  echo '{"tool_name":"Bash","tool_input":{"command":"rm -rf ."}}' | python .cataforge/hooks/guard_dangerous.py
  Expected: exit 2, stderr shows block reason

  echo '{"tool_name":"Bash","tool_input":{"command":"git status"}}' | python .cataforge/hooks/guard_dangerous.py
...
from _hook_base import read_hook_input, matches_capability
