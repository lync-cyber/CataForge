...
Test:
  echo '{"tool_name":"Agent","tool_result":"<agent-result><status>completed</status><outputs>f.md</outputs><summary>done</summary></agent-result>"}' | python .cataforge/hooks/validate_agent_result.py
