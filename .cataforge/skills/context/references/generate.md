...
## 创建骨架
1. 查注册表 `Read .cataforge/skills/doc-gen/templates/_registry.yaml`,据 `{template_id}` 取 `path`,读模板
...
完整模板映射与拆分表见 `.cataforge/skills/doc-gen/templates/_registry.yaml` 与 doc-gen 模板目录。
