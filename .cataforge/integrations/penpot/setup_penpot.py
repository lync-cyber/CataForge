...
用法:
  python .cataforge/integrations/penpot/setup_penpot.py deploy      # 完整部署
  python .cataforge/integrations/penpot/setup_penpot.py mcp-only    # 仅 MCP
  python .cataforge/integrations/penpot/setup_penpot.py start       # 启动服务
  python .cataforge/integrations/penpot/setup_penpot.py stop        # 停止服务
  python .cataforge/integrations/penpot/setup_penpot.py status      # 查看状态
  python .cataforge/integrations/penpot/setup_penpot.py --ensure    # 快速检查/启动
...
# 确保 .cataforge/scripts/lib/_common 可导入
_here = os.path.dirname(os.path.abspath(__file__))
_project_root = os.path.abspath(os.path.join(_here, os.pardir, os.pardir, os.pardir))
sys.path.insert(0, os.path.join(_project_root, ".cataforge", "scripts", "lib"))
from _common import (
    BOLD,
    CYAN,
    DIM,
