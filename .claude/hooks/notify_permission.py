...
$xml.LoadXml('<toast><visual><binding template="ToastGeneric"><text>{title}</text><text>{safe_msg}</text></binding></visual></toast>')
...
def beep():
    # Triple beep pattern — distinct from task-done single beep
