...
Test:
  echo '{"tool_name":"AskUserQuestion","tool_input":{"questions":[{"question":"Q","options":[{"label":"A (Recommended)","description":"x"},{"label":"B","description":"y"}]}]},"tool_response":{"answers":{"Q":"B"}}}' | python .claude/hooks/detect_correction.py
...
def _append_corrections_log(
    ...
    if not os.path.exists(log_path):
        header = (
            "# Corrections Log\n\n"
            "> 本文件由 `.claude/hooks/detect_correction.py` 追加写入。\n"
