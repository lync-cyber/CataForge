...
## Input Contract
- 必须加载: 通过 `python .claude/scripts/docs/load_section.py` 按 T-xxx 加载 dev-plan 中已完成的任务卡（含 tdd_acceptance 和 deliverables），按任务定位对应的 src/ 和 tests/ 文件
...
- 加载示例: `python .claude/scripts/docs/load_section.py dev-plan#§2.T-001 dev-plan#§2.T-002 arch#§3.API-001`
