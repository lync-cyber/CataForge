...
def test_codex_prunes_orphan_toml_when_agent_removed(
    ...
    actions = steps.deploy_agents(codex_adapter, src, tmp_path)
...
def test_codex_does_not_prune_user_authored_toml(
    ...
    steps.deploy_agents(codex_adapter, src, tmp_path)
...
def test_codex_dry_run_reports_prune_without_writing(
    ...
    actions = steps.deploy_agents(codex_adapter, src, tmp_path, dry_run=True)
...
def test_opencode_prunes_orphan_md_when_agent_removed(
    ...
    actions = steps.deploy_agents(opencode_adapter, src, tmp_path)
...
def test_opencode_does_not_prune_user_authored_md(
    ...
    steps.deploy_agents(opencode_adapter, src, tmp_path)
...
def test_opencode_dry_run_reports_prune_without_writing(
    ...
    actions = steps.deploy_agents(opencode_adapter, src, tmp_path, dry_run=True)
