...
importing ``cataforge.core.feedback.<name>``.
...
from cataforge.core.feedback.assemblers import (
    assemble_bug,
...
__all__ = [
    "DEFAULT_EVENT_LOG_TAIL", "DOCTOR_TRANSCRIPT_CHAR_CAP", "PACKAGE_VERSION",
    "RETRO_TRIGGER_UPSTREAM_GAP_DEFAULT", "UPSTREAM_GAP", "CorrectionEntry",
    "FeedbackPayload", "collect_corrections", "collect_doctor_summary",
    "collect_environment", "collect_framework_review", "collect_recent_events",
    "logger", "redact", "upstream_gap_count", "derive_doc_id",
    "render_bug_report", "render_correction_export", "render_suggestion",
    "assemble_bug", "assemble_correction_export", "assemble_suggestion",
    "iter_clipboard_commands",
]
