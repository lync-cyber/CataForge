...
class SoftwareArtifact(ConfiguredBaseModel):
    ...
    content_hash: Optional[str] = Field(default=None, description="""SHA-256 of the source Markdown section, mirrors .doc-index.json content_hash.""", json_schema_extra = { "linkml_meta": {'domain_of': ['SoftwareArtifact', 'Document', 'Section']} })
...
class Document(ConfiguredBaseModel):
    ...
    created_at: Optional[datetime ] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['SoftwareArtifact', 'Project', 'Document']} })
    updated_at: Optional[datetime ] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['SoftwareArtifact', 'Project', 'Document']} })
    has_section: Optional[list[str]] = Field(default=None, description="""Document → its sections.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Document']} })


class Section(ConfiguredBaseModel):
    """
    Heading-delimited section of a Document. Carries narrative prose (narrative_body) and the structured entities sourced from it (contains_entity), making whole-document content — structured and prose — first-class graph content.
    """
    ...
    content_hash: Optional[str] = Field(default=None, description="""SHA-256 of the source Markdown section, mirrors .doc-index.json content_hash.""", json_schema_extra = { "linkml_meta": {'domain_of': ['SoftwareArtifact', 'Document', 'Section']} })
    source_doc: Optional[str] = Field(default=None, description="""Relative path of the Markdown file the entity was exported from.""", json_schema_extra = { "linkml_meta": {'domain_of': ['SoftwareArtifact', 'Document', 'Section']} })
    part_of_document: Optional[str] = Field(default=None, description="""Section → the document it belongs to.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Section']} })
