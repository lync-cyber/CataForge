...
linkml_meta = LinkMLMeta({'default_prefix': 'cfgov',
     'default_range': 'string',
     'description': "Optional sub-ontology covering CataForge's "
                    '*framework-internal* assets (skills, agent instances, rules, '
                    'script tools, document templates, event-log entries). Strict '
                    'directionality: governance MAY reference business '
                    '(`generates` / `consumed_by`), but the business ontology '
                    '(core.yaml) MUST NOT import governance. Disabled when '
                    '`KGConfig.governance = false` — the business-only mode every '
                    'downstream user project ships with.',
...
class GovernanceAssetKindEnum(str, Enum):
    skill = "skill"
    agent = "agent"
    rule = "rule"
...
class SoftwareArtifact(ConfiguredBaseModel):
    ...
    description: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['SoftwareArtifact', 'Project', 'GovernanceAsset']} })
...
class TechStack(SoftwareArtifact):
    ...
    narrative_body: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['TechStack', 'Section']} })
...
class Release(SoftwareArtifact):
    ...
    version: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Release', 'Document', 'GovernanceAsset']} })
...
class GovernanceAsset(ConfiguredBaseModel):
    """
    Common ancestor of every framework-internal asset.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'abstract': True,
         'class_uri': 'cfgov:GovernanceAsset',
         'from_schema': 'https://cataforge.dev/governance/governance'})

    asset_id: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })
    asset_name: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })
    asset_kind: GovernanceAssetKindEnum = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })
    description: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['SoftwareArtifact', 'Project', 'GovernanceAsset']} })
    file_path: Optional[str] = Field(default=None, description="""Path under .cataforge/ — for traceability, not a KG identity.""", json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })
    version: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Release', 'Document', 'GovernanceAsset']} })
    generates: Optional[list[str]] = Field(default=None, description="""Governance asset produced the business artifact (e.g. architect Agent generated this Module). Cross-namespace reference resolves via the `core` import; LinkML's `gen-pydantic` requires the bare class name in `range:` even when the class lives in an imported schema.""", json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })


class Skill(GovernanceAsset):
    """
    A .cataforge/skills/<name>/SKILL.md unit.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'cfgov:Skill',
         'from_schema': 'https://cataforge.dev/governance/governance'})
...
class Agent(GovernanceAsset):
    """
    An SDLC role agent definition (one of the 6 cores or an extension).
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'cfgov:Agent',
         'from_schema': 'https://cataforge.dev/governance/governance'})

    invokes_skill: Optional[list[str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Agent']} })
    uses_rule: Optional[list[str]] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Agent']} })
    asset_id: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })
    asset_name: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })
    asset_kind: GovernanceAssetKindEnum = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })
    description: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['SoftwareArtifact', 'Project', 'GovernanceAsset']} })
...
class Rule(GovernanceAsset):
    """
    A .cataforge/rules/*.md prompt-time rule.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'cfgov:Rule',
         'from_schema': 'https://cataforge.dev/governance/governance'})
...
class ScriptTool(GovernanceAsset):
    """
    A Python script under scripts/ exposed via skill.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'cfgov:ScriptTool',
         'from_schema': 'https://cataforge.dev/governance/governance'})
...
class DocumentTemplate(GovernanceAsset):
    """
    A doc-gen template (.cataforge/templates/...).
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'cfgov:DocumentTemplate',
         'from_schema': 'https://cataforge.dev/governance/governance'})
...
class SkillLoader(GovernanceAsset):
    """
    The runtime registry that dispatches skills.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'cfgov:SkillLoader',
         'from_schema': 'https://cataforge.dev/governance/governance'})
...
class EventLogEntry(GovernanceAsset):
    """
    One row from docs/EVENT-LOG.jsonl, lifted into the graph.
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'cfgov:EventLogEntry',
         'from_schema': 'https://cataforge.dev/governance/governance'})

    event_kind: Optional[EventKindEnum] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['EventLogEntry']} })
    event_timestamp: Optional[datetime ] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['EventLogEntry']} })
    event_payload: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['EventLogEntry']} })
    asset_id: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })
    asset_name: str = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })
    asset_kind: GovernanceAssetKindEnum = Field(default=..., json_schema_extra = { "linkml_meta": {'domain_of': ['GovernanceAsset']} })
    description: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['SoftwareArtifact', 'Project', 'GovernanceAsset']} })
...
GovernanceAsset.model_rebuild()
Skill.model_rebuild()
Agent.model_rebuild()
Rule.model_rebuild()
ScriptTool.model_rebuild()
DocumentTemplate.model_rebuild()
SkillLoader.model_rebuild()
