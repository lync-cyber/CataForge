...
from cataforge.integrations.penpot.client import _run_claude_mcp, register_claude_mcp
from cataforge.integrations.penpot.docker import (
    _extract_secret_key,
...
from cataforge.integrations.penpot.mcp_process import (
    _diagnose_mcp_log,
    _is_mcp_running,
    _mcp_npx_env,
    _read_mcp_pid,
...
# the test suite keep importing/patching ``cataforge.integrations.penpot.<name>``
