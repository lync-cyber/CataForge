...
执行: `python .cataforge/skills/sprint-review/scripts/sprint_check.py {sprint_number} --dev-plan docs/dev-plan/ --src-dir src/ --test-dir tests/ --reviews-dir docs/reviews/code/`
