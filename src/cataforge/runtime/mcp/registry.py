...
2. Convention: pyproject.toml entry_points "cataforge.runtime.mcp"
...
from cataforge.core.schema.mcp_spec import TRUSTED_COMMAND_PREFIXES, MCPServerSpec, MCPServerState

logger = logging.getLogger("cataforge.runtime.mcp")
...
class MCPRegistry:
    ...
    def _scan_entry_points(self) -> None:
        """Scan pip-installed packages for cataforge.runtime.mcp entry points."""
        try:
