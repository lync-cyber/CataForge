...
Built-in skills are invoked via ``python -m cataforge.runtime.skill.builtins.<pkg>.<script>``.
...
class SkillRunner:
    ...
    def run(
        ...
        *,
        ...
        if meta.builtin:
            module_path = f"cataforge.runtime.skill.builtins.{script_entry['module']}"
