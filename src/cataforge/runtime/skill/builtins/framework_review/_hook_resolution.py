...
def resolve_builtin_hook_dir() -> Path | None:
    """Locate the cataforge.runtime.hook.scripts package directory.
    ...
    """
    try:
        pkg = importlib.resources.files("cataforge.runtime.hook.scripts")
...
def resolve_hook_script(
    ...
    Mirrors the resolution logic in cataforge.runtime.hook.bridge so audit and
