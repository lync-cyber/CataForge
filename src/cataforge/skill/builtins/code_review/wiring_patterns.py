...
shipped YAML files in ``cataforge.skill.builtins.code_review.rules``
...
location (see ``cataforge.skill.builtins.code_review.rules`` for
...
_BUILTIN_MODULE = "cataforge.skill.builtins.code_review"
